...
import agingReport from '@salesforce/apex/FinsysAgingReport.agingReport';
import agingReportCount from '@salesforce/apex/FinsysAgingReport.agingReportCount';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class FinsysAgingReport extends LightningElement {
    ...
    get sortIcons() {
        return {
            ...
            Customer_Account_Balance__c: this.sortedBy === 'Customer_Account_Balance__c' ? (this.sortedDirection === 'asc' ? 'utility:arrowdown' : 'utility:arrowup') : 'utility:arrowdown'
    ...
    get sortedClassTotalBalance(){
        return `slds-is-sortable ${this.sortedBy === 'Customer_Account_Balance__c' ? 'sorted' : ''}`;
