/**********************************************************************************************
 * NAME:  recovery_badgeRecoveredLWC.js
 * DESCRIPTION: Covid-19 BadgeRecovered Page. 
 *
 ...
 * Mohan Mullapudi               6/10/2020                         Created the first version
 *
*********************************************************************************************/
...
import label_badgeConfirmation from '@salesforce/label/c.Recovery_badgeConfirmation_Part1';
...
export default class Navtab extends NavigationMixin(LightningElement) {
    ...
    /*Onfeedback(event){
        location.href = label_Recovery_FeedbackPage;
    } */
