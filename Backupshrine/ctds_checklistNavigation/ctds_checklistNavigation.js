        ...
        try {
            ...
            if (value) {
                for (let i = 0; i < value.length; i++) {
                    let obj = {};
                    obj.title = value[i].label;
                    if (value[i].hasOwnProperty('name') && this.currentStage.hasOwnProperty('name')) {
                        if(value[i].name == this.currentStage.name ) {
                            obj.isSectionComplete = false;
                            obj.isCurrentTab = true;
