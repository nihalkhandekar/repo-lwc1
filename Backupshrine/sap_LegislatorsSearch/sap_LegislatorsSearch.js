...
import legislativeData from '@salesforce/apex/SAP_LegislativeController.legislativeData';
import getlegislativeDataCount from '@salesforce/apex/SAP_LegislativeController.getlegislativeDataCount';
...
export default class LegislatorsSearch extends  NavigationMixin(LightningElement) {
    ...
    get sortIcons() {
        return {
            SAP_Legislator_Title__c: this.sortedBy === 'SAP_Legislator_Title__c' ? (this.sortedDirection === 'asc' ? 'utility:arrowdown' : 'utility:arrowup') : 'utility:arrowdown',
            ...
            SAP_DistrictID__c: this.sortedBy === 'SAP_DistrictID__c' ? (this.sortedDirection === 'asc' ? 'utility:arrowdown' : 'utility:arrowup') : 'utility:arrowdown'

        };
    }

    get sortedClassOfficialTitle(){
        return `slds-is-sortable ${this.sortedBy === 'SAP_Legislator_Title__c' ? 'sorted' : ''}`;
    ...
    get sortedClassDistrict(){
        return `slds-is-sortable ${this.sortedBy === 'SAP_DistrictID__c' ? 'sorted' : ''}`;
    }
    ...
    handleNavigateToView(recordId){
        this[NavigationMixin.Navigate]({
            ...
            attributes: {
            componentName: 'c__sap_LegislativeModal' // Replace with your target component's name
            },
            state: {
    ...
    //     const result = await sap_LegislativeModal.open({
    //         size: 'small',
