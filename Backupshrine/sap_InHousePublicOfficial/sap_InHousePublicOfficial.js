...
import getPublicOfficials from '@salesforce/apex/SAP_InHousePublicOfficialController.getPublicOfficial';
import getPublicOfficialCount from '@salesforce/apex/SAP_InHousePublicOfficialController.getPublicOfficialCount';
import deleteContact from '@salesforce/apex/SAP_InHousePublicOfficialController.deleteContact';
    ...
    loadApplications() {
        ...
        .then(result => {
             ...
             const newRecords = result.map(row => {
                return {
                    ...row,
                    canEdit: row.SAP_Position__c !== 'Notary Public' // Check if position is 'Notary Public'
                };
            });
     ...
     async openAddModal() {
        ...
        try {
            ...
            this[NavigationMixin.Navigate]({
                ...
                attributes: {
                    componentName: 'c__sap_InHousePublicOfficialModal'  // The target component name
                },
                state: {
                  c__record: '',
                  c__mode:'addnew'
