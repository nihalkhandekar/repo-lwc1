...
export default class finsysSendEmailModal extends LightningModal {
    @api recordId;
    ...
    async connectedCallback() {
        try {
            await loadStyle(this, modalStateSealRequest);
        ...
        try {
            ...
            if (result && result.userInfo) {
                ...
                this.formData.description = `
                    Hi ${userInfo.lastName} ${userInfo.firstName},<br><br>
