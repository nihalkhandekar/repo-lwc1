...
import getDailySettlementReport from '@salesforce/apex/FinsysDailySettlementReport.getDailySettlementReport';

export default class FinsysDailySettlementReport extends LightningElement {
    @track dailySettlementReport = []; // Holds the report data
    @track isRecordsLoading = false;
    @track isNoData = false;
    @track reportDate = null;
    ...
    handleDownloadPdf() {
        ...
        if (pdfGenerator) {
            ...
            pdfGenerator.dailySettlementSummaryFinsys(headers, data, fileName, reportDate, generatedDate);
        } else {
