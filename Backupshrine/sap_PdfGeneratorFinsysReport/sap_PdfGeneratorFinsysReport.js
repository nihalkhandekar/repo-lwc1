...
export default class sap_PdfGeneratorFinsysReport extends LightningElement {
            ...
            for (const paymentType of paymentTypes) {
                ...
                if (transactions.length > 0) {
                    ...
                    const tableData = transactions.map(record => {
                        ...
                        return [
                            record.parent.SAP_Sequence_Number__c,
                            `${record.parent.SAP_First_Name__c} ${record.parent.SAP_Last_Name__c}`,
