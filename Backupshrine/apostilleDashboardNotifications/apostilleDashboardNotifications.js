...
import apostilleDashboardNotifiacations from '@salesforce/resourceUrl/apostilleDashboardNotifiacations'; // Import the CSS file
import notificationsLoad from "@salesforce/apex/apostilleNotificationFetchController.Notifications";
// import redirectToMoreDetails from "@salesforce/apex/ApostilleSubmittedRequestController.getApplicationsFromNotification";
import notificationsMoveToAllRead from "@salesforce/apex/apostilleNotificationFetchController.notificationsMoveToAllRead";
...
processNotification() {
    ...
    connectedCallback() {
        ...
        // Load the CSS file
        // Promise.all([
            loadStyle(this, apostilleDashboardNotifiacations) // Load the CSS file
        // ]).then(() => {
