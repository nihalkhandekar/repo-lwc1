...
import SUFFIX from '@salesforce/schema/Contact.Suffix_values__c';
import SALUTATION_FIELD from '@salesforce/schema/Contact.prefix_values__c';
import fetchLegislativeData from '@salesforce/apex/LegislatorController.fetchLegislativeData';
import updateLegislativeData from '@salesforce/apex/LegislatorController.updateLegislativeData';
...
async fetchExistingData() {
    fetchLegislativeData({ recordId: this.idofrecord })
        .then((data) => {
            ...
            this.prefix = data.records[0]?.prefix_values__c || '';
            this.suffix = data.records[0]?.Suffix_values__c || '';
            this.title = data.records[0]?.Legislator_Title__c || '';
            this.party = data.records[0]?.Party__c || '';
            this.district = data.records[0]?.DistrictID__c || '';
            this.lastName = data.records[0]?.LastName || '';
            this.firstName = data.records[0]?.FirstName || '';
            this.middleName = data.records[0]?.MiddleName || '';
            this.personalName = data.records[0]?.Personal_Name__c || '';
            this.email = data.records[0]?.Email || '';
            this.address1 = data.records[0]?.MailingStreet || '';
            this.address2 = data.records[0]?.MailingAddress2__c || '';
            ...
            this.extension = data.records[0]?.Extension__c || '';
            this.telephone = data.records[0]?.Phone || '';
            this.selectedType = data.records[0]?.Preffered_address__c || '';

            this.homeAddress1 = data.records[0]?.Residence_Street_Address_1__c || '';
            this.homeAddress2 = data.records[0]?.Residence_Street_Address_2__c || '';
            this.homeCity = data.records[0]?.Residence_City__c || '';
            this.homeState = data.records[0]?.Residence_State__c || '';
            this.homeCountry = data.records[0]?.Residence_Country__c || '';
            this.homeZipCode = data.records[0]?.Residence_Zip_Code__c || '';
            this.homeTelephone = data.records[0]?.Residential_Phone__c || '';
            this.homeFax = data.records[0]?.Residential_Fax__c || '';
            this.homeExtension = data.records[0]?.Residential_Extension__c || '';

            this.businessAddress1 = data.records[0]?.OtherStreet || '';
            this.businessAddress2 = data.records[0]?.Other_Address2__c || '';
            ...
            this.businessFax = data.records[0]?.Other_Fax__c || '';
            this.businessExtension = data.records[0]?.Other_Extension__c || '';
    ...
    goBackModal() {
        ...
        try {
            ...
            this[NavigationMixin.Navigate]({
                ...
                attributes: {
                    componentName: 'c__legislatorsSearch'  // The target component name
                }
            });
