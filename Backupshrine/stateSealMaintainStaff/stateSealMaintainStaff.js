...
import searchStaffData from '@salesforce/apex/MaintainStaffDataController.searchStaffData';
...
import staffModal from 'c/staffModal';
import stateSealM from '@salesforce/resourceUrl/stateSealM';
import modalDefaultStaff from 'c/modalDefaultStaff';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import deleteContact from '@salesforce/apex/MaintainStaffDataController.deleteContact';
...
console.log('search param: ',searchCriteria);
    ...
    get sortIcons() {
        return {
            ...
            Staff_Title__c: this.getSortIconName('Staff_Title__c'),
            Division__c: this.getSortIconName('Division__c'),
    ...
    get sortedClassStaffTitle() {
        return `slds-is-sortable ${this.sortedBy === 'Staff_Title__c' ? 'sorted' : ''}`;
    }

    get sortedClassDivision() {
        return `slds-is-sortable ${this.sortedBy === 'Division__c' ? 'sorted' : ''}`;
    }
