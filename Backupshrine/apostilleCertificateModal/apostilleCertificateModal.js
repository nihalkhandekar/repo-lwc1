...
import certificateImage from '@salesforce/resourceUrl/certificateImage';
import getDocumentChecklistItemDetails from '@salesforce/apex/ApostilleLetterController.getDocumentChecklistItemDetails';
import jsonLabels from '@salesforce/apex/LabelsForOnlineApostile.GetLabels';
import getPaymentDetails from '@salesforce/apex/ApostilleLetterController.getPaymentDetails';
import getDocumentChecklistItems from '@salesforce/apex/ApostilleLetterController.getDocumentChecklistItems';
        ...
        try {
            ...
            if (response && response.length > 0) {
                ...
                this.checklistData = {
                    ...
                    position: checklistItem.Position__c,
                    destination: checklistItem.Country__c,
