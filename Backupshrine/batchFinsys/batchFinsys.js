...
import getActivityTransactionData from "@salesforce/apex/BatchFinsysController.getActivityTransactionData";
import updateStatus from "@salesforce/apex/BatchFinsysController.updateStatus";
...
export default class BatchFinsys extends NavigationMixin(LightningElement)  {
    ...
    handleBadgeClick(event) {
      ...
      wiredTransactionData(result) {
        ...
        const { data, error } = result;
          ...
          if (data) {
              this.totalRecords = data.totalRecords;  // needs to be changes
    ...
    handlePageChange(event) {
      ...
      handleFilterSelect(event){
        ...
        this.searchParams = { ...this.searchParams, 
                        status: selectedValue, offsetVal: 0 };
        ...
        updateStatus({ recordId: selectedId, status: selectedValue })
          .then((result) => {
              if (result.startsWith('Success')) {
                  ...
                  this.searchResult = [];
                  return refreshApex(this.wiredActivityTransactionResult); // Refresh data
              } else {
        ...
        async viewRequest(recordId) {
          this[NavigationMixin.Navigate]({
              type: 'standard__component',
                  attributes: {
                          componentName: 'c__viewOrEditBatchFinsys' // Replace with your target component's name
                  },
                  state: {
                      c__mode:'view',
