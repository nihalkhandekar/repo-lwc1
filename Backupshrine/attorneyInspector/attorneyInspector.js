...
import getAttorneyRecord from '@salesforce/apex/AttorneyInspectorController.getAttorneyRecord';
import getAttorneyRecordCount from '@salesforce/apex/AttorneyInspectorController.getAttorneyRecordCount';
...
loadApplications() {
    ...
    .then(result => {
        ...
        this.searchAttorneyData = this.searchAttorneyData ?
            [...this.searchAttorneyData, ...processedResult] :
            processedResult;
        this.recordCount = result.length;
        console.log('searchAttorneyData--->'+JSON.stringify(this.searchAttorneyData));
